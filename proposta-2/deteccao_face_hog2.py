...
subdetector = ['Olha a frente', 'Vista a esquerda', 'Vista a direita', 'A frente girando a esquerda', 'A frente girando a direita']

imagem = cv2.imread("fotos/grupo.0.jpg")
detector = dlib.get_frontal_face_detector()
facesDetecadas, pontuacao, idx = detector.run(imagem, 1)
#print(facesDetecadas)
#print(pontuacao)
#print(idx)
for i,d in enumerate(facesDetecadas):
